...
> Supabase tables modeled as ER-style tables (classes = DB entities). Cardinality: `||` = 1, `o{` = 0..*, `o|` = 0..1.
...
erDiagram
    ...
    WANTED_LISTINGS ||--o{ WANTED_LISTING_VIEWS : tracked by

    AUTH_USERS ||--o{ PROPERTY_VIEWS : viewed
    AUTH_USERS ||--o{ WANTED_LISTING_VIEWS : viewed
```
